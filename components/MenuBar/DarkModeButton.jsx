...
import { whileTap, transition } from "./data";
  ...
  return (
    ...
    >
      {hasMounted && theme == "dark" ? (
        <SunIcon className="h-6 w-6 text-alice-400 hover:text-alice-500" />
      ) : (
        <MoonIcon className="h-6 w-6 text-alice-400 hover:text-alice-500" />
      )}
    </button>
  );
};
